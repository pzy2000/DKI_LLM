...
class VASConfig:
    ...
    eval_dataset_name: Optional[str] = ""
    save_freq: Optional[int] = field(default=100, metadata={"help": "n steps to save the model"})
    output_dir: Optional[str] = field(default="", metadata={"help": "the outpur dir"})
    ...
    tracker_kwargs: JSONDict = field(default_factory=lambda: {"wandb": {"entity": "", "name": ""}})
    ...
    tracker_project_name: str = "value"
    ...
    """Type of mixed precision to use, can be 'fp16' or 'bf16'"""
